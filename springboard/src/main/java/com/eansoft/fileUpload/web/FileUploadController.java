package com.eansoft.fileUpload.web;
...
import com.eansoft.fileUpload.service.FileUploadUtils;
import com.eansoft.fileUpload.service.MediaUtils;
...
public class FileUploadController {
	...
	public ResponseEntity<String> uploadAjax(MultipartFile file) throws Exception {
		...
		return new ResponseEntity<String>(
				FileUploadUtils.uploadFile(uploadPath, file.getOriginalFilename(), file.getBytes()), HttpStatus.OK);
	}
